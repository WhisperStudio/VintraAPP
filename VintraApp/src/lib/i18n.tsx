...
const T = {
  en: {
    ...
    auth_verify_msg: 'We sent a verification email. After verifying, sign in again and the app will connect matching invitations by email or phone.',
  ...
  no: {
    ...
    auth_verify_msg: 'Vi har sendt deg en bekreftelsesepost. Etter bekreftelse logger du inn igjen, så kobler appen invitasjoner som matcher e-post eller telefon.',
